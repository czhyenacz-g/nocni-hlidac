...
export const CINEMATIC_SCENES: Record<CinematicSceneId, CinematicScene> = {
  ...
  intro: {
    id: "intro",
    imageSrc: assetPath("/object_13/story/intro_bg.webp"),
    segments: [
      { id: "greeting" },
      { id: "profile_match" },
      { id: "no_complaints" },
  ...
  old_guard_first_death_warning: {
    ...
    imageSrc: assetPath("/object_13/story/story_1.webp"),
    segments: [
      { id: "baf", audioSrc: assetPath("/object_13/story/segments/story_1_baf.m4a") },
      { id: "another_one", audioSrc: assetPath("/object_13/story/segments/story_1_another_one.m4a") },
      { id: "im_the_tech", audioSrc: assetPath("/object_13/story/segments/story_1_im_the_tech.m4a") },
      { id: "last_day", audioSrc: assetPath("/object_13/story/segments/story_1_last_day.m4a") },
      { id: "advice_intro", audioSrc: assetPath("/object_13/story/segments/story_1_advice_intro.m4a") },
      { id: "creatures", audioSrc: assetPath("/object_13/story/segments/story_1_creatures.m4a") },
      { id: "cameras", audioSrc: assetPath("/object_13/story/segments/story_1_cameras.m4a") },
      { id: "door_power", audioSrc: assetPath("/object_13/story/segments/story_1_door_power.m4a") },
      { id: "dont_panic_close", audioSrc: assetPath("/object_13/story/segments/story_1_dont_panic_close.m4a") },
      { id: "watch_hallway", audioSrc: assetPath("/object_13/story/segments/story_1_watch_hallway.m4a") },
      { id: "close_the_door", audioSrc: assetPath("/object_13/story/segments/story_1_close_the_door.m4a") },
      { id: "light_tip", audioSrc: assetPath("/object_13/story/segments/story_1_light_tip.m4a") },
      { id: "farewell", audioSrc: assetPath("/object_13/story/segments/story_1_farewell.m4a") },
    ],
  },
  ...
  think_it_over_warning: {
    ...
    imageSrc: assetPath("/object_13/story/think_it_over_warning.webp"),
    segments: [
      { id: "dont" },
      { id: "not_a_coward" },
      { id: "find_warrior" },
  ...
  valhala_ending: {
    id: "valhala_ending",
    imageSrc: assetPath("/object_13/story/wallhala_ending.png"),
    segments: [
      { id: "silence" },
      { id: "wood_creaked" },
      { id: "hynek_raises_mug" },
      { id: "close_call", audioSrc: assetPath("/object_13/story/segments/valhala_close_call.m4a") },
      { id: "smiled" },
      { id: "thirty_or_valhalla", audioSrc: assetPath("/object_13/story/segments/valhala_thirty_or_valhalla.m4a") },
      { id: "pushed_beer" },
      { id: "not_bad_guard", audioSrc: assetPath("/object_13/story/segments/valhala_not_bad_guard.m4a") },
    ],
  },
  ...
  warrior_ending: {
    id: "warrior_ending",
    imageSrc: assetPath("/object_13/story/warior_ending.png"),
    segments: [
      { id: "thirtieth_day" },
      { id: "hynek_smiling" },
      { id: "not_just_good_watch", audioSrc: assetPath("/object_13/story/segments/posledni_smena_not_just_good_watch.m4a") },
      { id: "nodded" },
      { id: "you_became_warrior", audioSrc: assetPath("/object_13/story/segments/posledni_smena_you_became_warrior.m4a") },
      { id: "men_in_suits" },
      { id: "thank_you_bait", audioSrc: assetPath("/object_13/story/segments/posledni_smena_thank_you_bait.m4a") },
      { id: "points_at_generator" },
      { id: "your_generator", audioSrc: assetPath("/object_13/story/segments/posledni_smena_your_generator.m4a") },
      { id: "let_it_sink_in" },
      { id: "not_out_of_town", audioSrc: assetPath("/object_13/story/segments/posledni_smena_not_out_of_town.m4a") },
      { id: "you_bought_time", audioSrc: assetPath("/object_13/story/segments/posledni_smena_you_bought_time.m4a") },
      { id: "lights_on" },
      { id: "maximum_fireworks", audioSrc: assetPath("/object_13/story/segments/posledni_smena_maximum_fireworks.m4a") },
      { id: "opened_briefcase" },
      { id: "your_pay_plus_bonus", audioSrc: assetPath("/object_13/story/segments/posledni_smena_your_pay_plus_bonus.m4a") },
      { id: "grew_serious" },
      { id: "thousand_monsters", audioSrc: assetPath("/object_13/story/segments/posledni_smena_thousand_monsters.m4a") },
      { id: "step_to_door" },
      { id: "project_ends", audioSrc: assetPath("/object_13/story/segments/posledni_smena_project_ends.m4a") },
      { id: "turned_back" },
      { id: "good_luck_warrior", audioSrc: assetPath("/object_13/story/segments/posledni_smena_good_luck_warrior.m4a") },
    ],
  },
  ...
  no_kill_ending: {
    id: "no_kill_ending",
    imageSrc: assetPath("/object_13/story/no_kill_ending.png"),
    segments: [
      { id: "thirtieth_day" },
      { id: "hynek_before_dawn" },
      { id: "looked_you_over" },
      { id: "thirty_nights", audioSrc: assetPath("/object_13/story/segments/prvni_vyplata_thirty_nights.m4a") },
      { id: "handed_envelope" },
      { id: "good_guard", audioSrc: assetPath("/object_13/story/segments/prvni_vyplata_good_guard.m4a") },
      { id: "waited_for_truth" },
      { id: "lit_cigarette" },
      { id: "see_you_in_a_month", audioSrc: assetPath("/object_13/story/segments/prvni_vyplata_see_you_in_a_month.m4a") },
    ],
  },
};
