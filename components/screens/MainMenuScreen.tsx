  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md text-center pixel-panel p-8">
        ...
        {/* Výběr režimu — výraznější než spodní odkazy, ale menší než hlavní
            tlačítko (viz zadání). Vybraný režim čte existující .pixel-button
            data-active stav (stejný "červený zvýrazněný" vzor jako jinde v
            projektu, žádný nový styl navíc). */}
