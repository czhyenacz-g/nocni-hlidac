 ...
 * s pevným poměrem stran (16:9) a `object-contain`. Hotspot dveří
 * (`children`, viz DoorView.tsx) se pozicuje procentuálně vůči TOMUTO
 ...
 *
 * Velikost wrapperu (`.door-scene-frame`, styles/pixel.css) dopočítává podle
 * dostupné šířky/výšky viewportu, ať scéna na desktopu využije co nejvíc
 * plochy — `GameScreen.tsx` proto DoorView (na rozdíl od desk/generator)
 * nezabaluje do `max-w-md`, viz komentář tam.
 */
