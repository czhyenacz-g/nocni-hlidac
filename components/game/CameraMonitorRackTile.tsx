...
export default function CameraMonitorRackTile({
  ...
  return (
    ...
    >
      ...
      <span className="text-[9px] xl:text-[10px] text-gray-400 leading-tight">{cameraCopy.label}</span>
      ...
      {/* Popis kamery (viz COPY.cameras) — stejný hover reveal jako v
          mobilní CameraMonitorTile.tsx a v detailu (CameraView.tsx), jen
          jako plovoucí tooltip pod bezelem. */}
