...
export default function CameraDetailView({ camera, enemyStage, focused, lightOn, elapsedMs, onBack }: CameraDetailViewProps) {
  return (
    <div className="camera-detail-zoom-in flex flex-col gap-2">
      <CameraView camera={camera} enemyStage={enemyStage} focused={focused} lightOn={lightOn} elapsedMs={elapsedMs} />
