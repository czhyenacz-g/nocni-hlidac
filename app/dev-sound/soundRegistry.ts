...
export const SOUND_REGISTRY: Record<AudioEventId, SoundRegistryEntry> = {
  ...
  [AUDIO_EVENTS.ghoulCameraAttackWarning0]: {
    ...
    description: "Jedna z 5 variant řevu/komentáře Ghoula (ghoul_appear_0.mp3, rozřezáno z ghoul_appear_raw.wav), náhodně vybraná PŘESNĚ v okamžiku zahájení útoku na kameru.",
    guess: "Krátké zavytí/komentář, hraje současně s camera_damage_start.",
  ...
  [AUDIO_EVENTS.ghoulCameraAttackWarning1]: {
    ...
    description: "Jedna z 5 variant řevu/komentáře Ghoula (ghoul_appear_1.mp3, rozřezáno z ghoul_appear_raw.wav), náhodně vybraná PŘESNĚ v okamžiku zahájení útoku na kameru.",
    guess: "Krátké zavytí/komentář, hraje současně s camera_damage_start.",
    usedIn: "game/radio/useGhoulCameraAttackWarningMessage.ts — pickRandomGhoulCameraAttackWarningSound() na cameraAttackStartedSeq.",
  },
  [AUDIO_EVENTS.ghoulCameraAttackWarning2]: {
    id: AUDIO_EVENTS.ghoulCameraAttackWarning2,
    label: "Ghoul útočí na kameru 03",
    description: "Jedna z 5 variant řevu/komentáře Ghoula (ghoul_appear_2.mp3, rozřezáno z ghoul_appear_raw.wav), náhodně vybraná PŘESNĚ v okamžiku zahájení útoku na kameru.",
    guess: "Krátké zavytí/komentář, hraje současně s camera_damage_start.",
    usedIn: "game/radio/useGhoulCameraAttackWarningMessage.ts — pickRandomGhoulCameraAttackWarningSound() na cameraAttackStartedSeq.",
  },
  [AUDIO_EVENTS.ghoulCameraAttackWarning3]: {
    id: AUDIO_EVENTS.ghoulCameraAttackWarning3,
    label: "Ghoul útočí na kameru 04",
    description: "Jedna z 5 variant řevu/komentáře Ghoula (ghoul_appear_3.mp3, rozřezáno z ghoul_appear_raw.wav), náhodně vybraná PŘESNĚ v okamžiku zahájení útoku na kameru.",
    guess: "Krátké zavytí/komentář, hraje současně s camera_damage_start.",
    usedIn: "game/radio/useGhoulCameraAttackWarningMessage.ts — pickRandomGhoulCameraAttackWarningSound() na cameraAttackStartedSeq.",
  },
  [AUDIO_EVENTS.ghoulCameraAttackWarning4]: {
    id: AUDIO_EVENTS.ghoulCameraAttackWarning4,
    label: "Ghoul útočí na kameru 05",
    description: "Jedna z 5 variant řevu/komentáře Ghoula (ghoul_appear_4.mp3, rozřezáno z ghoul_appear_raw.wav), náhodně vybraná PŘESNĚ v okamžiku zahájení útoku na kameru.",
    guess: "Krátké zavytí/komentář, hraje současně s camera_damage_start.",
    usedIn: "game/radio/useGhoulCameraAttackWarningMessage.ts — pickRandomGhoulCameraAttackWarningSound() na cameraAttackStartedSeq.",
  },
  [AUDIO_EVENTS.titanEscape01]: {
    id: AUDIO_EVENTS.titanEscape01,
    label: "Titanův útěk 01",
    description: "Jedna z 5 rozřezaných variant hlášky 'Sakra, Titan utekl!...' (source: titan_escape_raw.wav), náhodně vybraná PŘESNĚ jednou při zahájení Titanova setkání.",
  ...
  [AUDIO_EVENTS.titanEscape02]: {
    ...
    label: "Titanův útěk 02",
    description: "Jedna z 5 rozřezaných variant hlášky 'Titan je venku!...' (source: titan_escape_raw.wav), náhodně vybraná PŘESNĚ jednou při zahájení Titanova setkání.",
    guess: "Krátká naléhavá rádiová hláška, jedna namluvená věta.",
    usedIn: "game/radio/useTitanEscapeMessage.ts — pickRandomTitanEscapeMessage() na zahájení encounteru.",
  },
  [AUDIO_EVENTS.titanEscape03]: {
    id: AUDIO_EVENTS.titanEscape03,
    label: "Titanův útěk 03",
    description: "Jedna z 5 rozřezaných variant hlášky 'Nezastřelíte ho ani neudržíte za dveřmi...' (source: titan_escape_raw.wav), náhodně vybraná PŘESNĚ jednou při zahájení Titanova setkání.",
    guess: "Krátká naléhavá rádiová hláška, jedna namluvená věta.",
    usedIn: "game/radio/useTitanEscapeMessage.ts — pickRandomTitanEscapeMessage() na zahájení encounteru.",
  },
  [AUDIO_EVENTS.titanEscape04]: {
    id: AUDIO_EVENTS.titanEscape04,
    label: "Titanův útěk 04",
    description: "Jedna z 5 rozřezaných variant hlášky 'Titan míří k vám!...' (source: titan_escape_raw.wav), náhodně vybraná PŘESNĚ jednou při zahájení Titanova setkání.",
    guess: "Krátká naléhavá rádiová hláška, jedna namluvená věta.",
    usedIn: "game/radio/useTitanEscapeMessage.ts — pickRandomTitanEscapeMessage() na zahájení encounteru.",
  },
  [AUDIO_EVENTS.titanEscape05]: {
    id: AUDIO_EVENTS.titanEscape05,
    label: "Titanův útěk 05",
    description: "Jedna z 5 rozřezaných variant hlášky 'Bože… Titan unikl...' (source: titan_escape_raw.wav), náhodně vybraná PŘESNĚ jednou při zahájení Titanova setkání.",
    guess: "Krátká naléhavá rádiová hláška, jedna namluvená věta.",
    usedIn: "game/radio/useTitanEscapeMessage.ts — pickRandomTitanEscapeMessage() na zahájení encounteru.",
  },
